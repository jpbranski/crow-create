          ...
          <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
            ...
            >
              <Tab
                ...
                iconPosition="start"
                id="playground-tab-0"
                aria-controls="playground-tabpanel-0"
              />
              <Tab
                icon={<TextFields />}
                label="Typography"
                iconPosition="start"
                id="playground-tab-1"
                aria-controls="playground-tabpanel-1"
              />
              <Tab
                icon={<ViewInAr />}
                label="Layout & Style"
                iconPosition="start"
                id="playground-tab-2"
                aria-controls="playground-tabpanel-2"
              />
              <Tab
                icon={<Visibility />}
                label="Preview"
                iconPosition="start"
                id="playground-tab-3"
                aria-controls="playground-tabpanel-3"
              />
              <Tab
                icon={<Code />}
                label="Exports"
                iconPosition="start"
                id="playground-tab-4"
                aria-controls="playground-tabpanel-4"
              />
            </Tabs>
          </Box>

...
const FONT_PAIRINGS: Record<string, string[]> = {
  Inter: ['Playfair Display', 'Merriweather', 'Source Serif Pro', 'Lora'],
  'Inter Tight': ['Playfair Display', 'Merriweather', 'Source Serif Pro', 'Lora'],
  Roboto: ['Playfair Display', 'Merriweather', 'Lato', 'Lora'],
  'Open Sans': ['Playfair Display', 'Merriweather', 'Montserrat', 'Lora'],
  Lato: ['Playfair Display', 'Merriweather', 'Roboto'],
  Montserrat: ['Merriweather', 'Source Serif Pro', 'Open Sans', 'Lora'],
  'IBM Plex Sans': ['Playfair Display', 'Merriweather', 'Lora', 'Source Serif Pro'],
  'Work Sans': ['Playfair Display', 'Merriweather', 'Lora', 'Source Serif Pro'],
  Lexend: ['Playfair Display', 'Merriweather', 'Source Serif Pro', 'Lora'],
  'Source Sans 3': ['Playfair Display', 'Merriweather', 'Source Serif Pro', 'Lora'],
  Figtree: ['Playfair Display', 'Merriweather', 'Source Serif Pro', 'Lora'],
  'Playfair Display': ['Inter', 'Roboto', 'Lato', 'Lexend', 'Figtree', 'IBM Plex Sans', 'Work Sans'],
  Merriweather: ['Inter', 'Roboto', 'Montserrat', 'Inter Tight', 'Source Sans 3', 'IBM Plex Sans', 'Work Sans'],
  Lora: ['Inter', 'Roboto', 'Montserrat', 'IBM Plex Sans', 'Work Sans', 'Open Sans'],
  'Source Serif Pro': ['Inter', 'Montserrat', 'Space Grotesk', 'IBM Plex Sans', 'Work Sans'],
  Sora: ['Playfair Display', 'Merriweather', 'Inter', 'Lora'],
  'Space Grotesk': ['Source Serif Pro', 'Merriweather', 'Inter', 'Lora'],
  'JetBrains Mono': ['Inter', 'Roboto', 'Source Sans 3', 'IBM Plex Sans'],
  'Fira Code': ['Inter', 'Roboto', 'Source Sans 3', 'IBM Plex Sans'],
}
